...
extern "C" {
	...
	typedef BOOLEAN(__stdcall *HidD_SetOutputReport_)(HANDLE handle, PVOID ReportBuffer, ULONG length);
...
#define STACK_BLUESOLEIL 1
#define STACK_MICROSOFT  2
int stack = STACK_UNKNOWN;
...
static hid_device *new_hid_device()
{
	...
	dev->ol.hEvent = CreateEvent(NULL, TRUE, FALSE /*inital state f=nonsignaled*/, NULL);
